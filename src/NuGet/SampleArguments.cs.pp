...
namespace $rootnamespace$
{
    ...
    class SampleArguments
    {
        ...
        public static SampleArguments Create(string[] args)
        {
            ...
            CommandLineParser parser = new CommandLineParser(typeof(SampleArguments));
            ...
            try
            {
                ...
                SampleArguments result = (SampleArguments)parser.Parse(args);
                if( result != null )
                    return result;
            }
