...
public enum CancelMode
{
    ...
    /// <see cref="CommandLineParser.Parse{T}(ParseOptions?)" qualifyHint="true"/> method, will return a <see langword="null"/>
    /// value. The <see cref="ParseResult.Status" qualifyHint="true"/> property will be <see cref="ParseStatus.Canceled" qualifyHint="true"/>.
    /// </summary>
    Abort,
    /// <summary>
