...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="KeyConverterAttribute"/> class with the
    ...
    public KeyConverterAttribute([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type converterType)
#else
    public KeyConverterAttribute(Type converterType)
#endif
    {
    ...
    /// </exception>
#if NET6_0_OR_GREATER
    public KeyConverterAttribute([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] string converterTypeName)
#else
    public KeyConverterAttribute(string converterTypeName)
#endif
    {
