...
{
    /// <summary>
    /// Specifies a <see cref="System.ComponentModel.TypeConverter"/> to use for the keys of a 
    /// dictionary argument.
    /// </summary>
    /// <remarks>
    /// <para>
    ///   This attribute can be used along with <see cref="ValueTypeConverterAttribute"/> to
