...
namespace Ookii.CommandLine
{
    ...
    ///   mode. It is ignored if the <see cref="CommandLineParser.Mode"/> property is not
    ///   <see cref="ParsingMode.LongShort"/>, or if the argument doesn't have a primary
    ///   <see cref="CommandLineArgumentAttribute.ShortName"/>.
    /// </note>
    /// <para>
    ...
    ///   includes the aliases. Set the <see cref="UsageWriter.IncludeAliasInDescription"/>
