Code snippets for Ookii.CommandLine
-----------------------------------

Several code snippets are provided to make working with Ookii.CommandLine
even easier:

clargclass: Snippet for am argument class, including a static Create method
            that parses arguments.
